...
![Total](https://img.shields.io/badge/Total-3816-blue?style=flat-square) ![Stars](https://img.shields.io/badge/Stars-11971k%2B-yellow?style=flat-square) ![Today](https://img.shields.io/badge/Today-12-green?style=flat-square) ![Updated](https://img.shields.io/badge/Updated-2026-04-05-orange?style=flat-square)
...
| 👥 Multi-Agent | 376 | ███ 9.9% |
| 💻 Coding Agents | 667 | █████ 17.5% |
| 🌐 Browser Agents | 298 | ██ 7.8% |
| 🔀 Workflow & Orchestration | 660 | █████ 17.3% |
| 📚 RAG & Knowledge | 323 | ██ 8.5% |
...
|:-:|---------|---:|-------:|-------------|
| 1 | [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) | 10,887 | +4966 | Collection of DESIGN.md files that capture design systems fr |
| 2 | [Gitlawb/openclaude](https://github.com/Gitlawb/openclaude) | 15,454 | +2273 | Open Claude Is Open-source coding-agent CLI for OpenAI, Gemi |
| 3 | [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | 139,067 | +2172 | The agent harness performance optimization system. Skills, i |
| 4 | [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto) | 19,768 | +1364 | A visual, example-driven guide to Claude Code — from basic c |
| 5 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 25,570 | +1209 | The agent that grows with you |
| 6 | [obra/superpowers](https://github.com/obra/superpowers) | 135,720 | +1133 | An agentic skills framework & software development methodolo |
| 7 | [JackChen-me/open-multi-agent](https://github.com/JackChen-me/open-multi-agent) | 4,520 | +975 | Production-grade multi-agent orchestration framework. Model- |
| 8 | [block/goose](https://github.com/block/goose) | 36,142 | +848 | an open source, extensible AI agent that goes beyond code su |
| 9 | [karpathy/autoresearch](https://github.com/karpathy/autoresearch) | 66,079 | +763 | AI agents running research on single-GPU nanochat training a |
| 10 | [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) | 24,173 | +668 | Teams-first Multi-agent orchestration for Claude Code |
| 11 | [anthropics/claude-code](https://github.com/anthropics/claude-code) | 109,127 | +632 | Claude Code is an agentic coding tool that lives in your ter |
| 12 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | 137,442 | +571 | The open source coding agent. |
| 13 | [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | 22,076 | +571 | GitNexus: The Zero-Server Code Intelligence Engine -       G |
| 14 | [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 58,052 | +486 | An open-source SuperAgent harness that researches, codes, an |
| 15 | [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | 104,343 | +461 | 🔥 The Web Data API for AI - Power AI agents with clean web d |
| 16 | [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents) | 47,275 | +406 | TradingAgents: Multi-Agents LLM Financial Trading Framework |
| 17 | [memvid/memvid](https://github.com/memvid/memvid) | 14,071 | +383 | Memory layer for AI Agents. Replace complex RAG pipelines wi |
| 18 | [jackwener/opencli](https://github.com/jackwener/opencli) | 13,218 | +379 | Make Any Website & Tool Your CLI. A universal CLI Hub and AI |
| 19 | [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | 48,448 | +378 | Bash is all you need -  A nano Claude Code–like agent, built |
| 20 | [vercel-labs/opensrc](https://github.com/vercel-labs/opensrc) | 1,505 | +375 | Fetch source code for npm packages to give AI coding agents  |
...
- [💻 Coding Agents](#coding) (667)
- [🌐 Browser Agents](#browser) (298)
- [🔀 Workflow & Orchestration](#workflow) (660)
- [📚 RAG & Knowledge](#rag) (323)
...
<p align="center"><sub>✨ Auto-curated · 2026-04-05 20:19:06</sub></p>
